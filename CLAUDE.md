...
- **저작권**: 조금이라도 저작권·라이선스에 걸릴 수 있는 것(남의 악보·멜로디·가사·이미지·폰트·데이터셋 게시, 저작권 곡 이름으로 콘텐츠 만들기, 퍼블릭 도메인 여부가 불확실한 곡 등)은 **진행하지 말고 먼저 사용자에게 말한다.** 퍼블릭 도메인이라도 편곡본은 편곡자 저작권이 별도라는 점까지 확인.
